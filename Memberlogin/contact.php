...
<body style="margin: 35px; font-family: Arial; ">
    ...
    <img class="dog5" src="dog5.jpg" height="600px" width="1000px"
    ...
    <?php
			 if(isset($_POST['Submit']))
             {
                ...
                //  }
                     ...
                     { mysqli_query($db,"INSERT INTO `messages` VALUES('$_POST[id]','$_POST[Fullname]','$_POST[Email]','$_POST[Phone]','$_POST[Message]')");
