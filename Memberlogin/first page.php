...
<body style="margin: 35px; font-family: Arial">
    <div class="top">
        ...
        <div class="Menubar">
            <a class="active" href="first%20page.php">Home</a>
        ...
        <div class="row">
            <div class="column">
                <div class="content">
                    ...
                    </a><img src="donation.png" height="150" width="150" alt="donation" style="
                margin-left: -100px;
                border-radius: 100px;
                border-color: grey;
                border-style: solid;
            ...
            <div class="column">
                ...
                ">
                    ...
                    </a><img src="dog.png" height="150" width="150" alt="parent" style="
                margin-left: -100px;
                border-radius: 100px;
                border-color: grey;
                border-style: solid;
            ...
            <div class="column">
                ...
                ">
                    ...
                    </a><img src="volunteering.png" height="150" width="150" alt="Volunteer" style="
                margin-left: -50px;
                margin-right: auto;
                position: relative;
                border-radius: 100px;
    ...
    <div class="container2">
        ...
        <div class="row">
            <div class="column">
                <div class="content">
                    <img src="dog1.jpg" alt="Mountains" style="
                width: 100%;
            ...
            <div class="column">
                <div class="content">
                    <img src="dog3.jpg" alt="Lights" style="
                width: 100%;
                border-top-right-radius: 15px;
                border-top-left-radius: 15px;
              " />
            ...
            <div class="column">
                <div class="content">
                    <img src="dog2.jpg" alt="Lights" style="
                width: 100%;
                border-top-right-radius: 15px;
                border-top-left-radius: 15px;
              " />
