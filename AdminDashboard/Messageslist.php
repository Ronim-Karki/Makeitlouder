...
<body>
    <div id="mySidenav" class="sidenav">
        ...
        <a href="Messageslist.php" class="active"><i class="fas fa-envelope"></i><span class="Opac">Messages</span></a>
    </div>
    <script>
...
{
	$sql= "SELECT ID, Fullname, Email, Phone, Message from messages";
        ...
        <div class="delete">
            <form method="post" action="">
                <td><input type="hidden" value="" name="ID">
                    <button name="view" type="submit" value="" class="view btn btn-success btn-sm ">view</button>
                </td>
            </form>
        </div>
        <div class="delete">
                ...
                <td><input type="hidden" value="" name="ID">
			...
			
                    {
                     ...
                     $ID = $_POST['del'];
                        ...
                        $sql=mysqli_query($db, "DELETE FROM `messages` WHERE `messages`.`id` = $ID;");
