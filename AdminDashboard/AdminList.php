...
<body>
    <div id="mySidenav" class="sidenav">
        ...
        <div class="dropdown-container" style="display: none;">
            ...
            <a href="AdminList.php" class="active">Admin List</a>
        </div>
...
?>
        <form class="create" method="" action="CreateAdmin.php">
...
{
	$sql= "SELECT  Email,concat(firstName,' ', lastName)as Name, concat(Street,' ', City,' ', State,' ', zipCode)as Address, ContactNumber from admin";
	$res= mysqli_query($db,$sql);
	if(mysqli_num_rows($res)==0)
	  {
		  echo "There's no admin";
	  }
	  else
	  {
        ...
        <div class="delete">
            <form method="post" id="delete" action="">
                <td><input type="hidden" value="" name="ID">
                    ...
                    if(isset($_POST['del'])){ 
                        $ID = $_POST['del'];
                        $sql=mysqli_query($db, "DELETE FROM `admin` WHERE Email = $ID");
