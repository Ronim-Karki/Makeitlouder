...
?>
        <div class="editProfile" style="text-align:center;">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <label for="Password"><b class="container" style="float: left;">Password:</b></label>
                <input class="form-control" type="password" placeholder="create password" name="Password" required
                    value="<?php echo $Password?>" style="width: 300px; margin:0 auto; " /><br />
                <label for="Password"><b class="container" style="float: left;">Confirm Password:</b></label>
                <input class="form-control" type="password" placeholder="Confirm password" name="ConfirmPassword"
                    required value="<?php echo $Password?>" style="width: 300px; margin:0 auto; " /><br />
	...
	if(isset($_POST['submit']))
	{
		...
		$sql1="UPDATE admin SET Password='$Password' WHERE Email='".$_SESSION['login_user']."';";
    ...
    <?php
        ...
        ?>
    <script type="text/javascript">
    alert("Cannot change Password, Password Donot Match.");
    window.location = "Profile.php";
    </script>
    <?php
        }
